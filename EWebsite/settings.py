...
SECRET_KEY = 'django-insecure-y^+gc5zwi-a+9=0$$1f8ca9hzg$(bh6c=e+caun(6*b(asu6=l'
...
EMAIL_HOST_PASSWORD = ''  # Your email password or app-specific password register in gmail 
